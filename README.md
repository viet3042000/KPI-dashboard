...
## Build dev
mvnw clean package -U -Dskip.unit.tests=true -DskipTests -Dskip.integration.tests=true

### Build Offline
mvnw clean package -U -Dskip.unit.tests=true -DskipTests -Dskip.integration.tests=true -o
...
To build the final jar and optimize the 4t_service application for production, run:
