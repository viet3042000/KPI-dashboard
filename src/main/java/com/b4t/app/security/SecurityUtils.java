...
public final class SecurityUtils {
    ...
    public static Optional<Long> getCurrentUserTenantId(UserRepository userRepository) {
        SecurityContext securityContext = SecurityContextHolder.getContext();
        ...
        if (user.isPresent()) {
            if (user.get().isActivated() && !Constants.ANONYMOUS_USER.equals(user.get().getLogin()))
                return Optional.of(user.get().getTenantId());
        }
        return Optional.empty();
    }
