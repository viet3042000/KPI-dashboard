 ...
 */
@Entity
@Table(name = "ict_rpt_graph")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class IctRptGraph implements Serializable {
    ...
    public IctRptGraph timeType(Long timeType) {
    ...
    public IctRptGraph prdId(Long prdId) {
        this.prdId = prdId;
        return this;
    }
    ...
    public IctRptGraph kpiId(Long kpiId) {
        this.kpiId = kpiId;
        return this;
    }
    ...
    public IctRptGraph kpiCode(String kpiCode) {
    ...
    public IctRptGraph kpiName(String kpiName) {
    ...
    public IctRptGraph objCode(String objCode) {
    ...
    public IctRptGraph objName(String objName) {
    ...
    public IctRptGraph parentCode(String parentCode) {
    ...
    public IctRptGraph parentName(String parentName) {
    ...
    public IctRptGraph inputLevel(Long inputLevel) {
    ...
    public IctRptGraph valPlan(Long valPlan) {
    ...
    public IctRptGraph valPlanMon(Long valPlanMon) {
    ...
    public IctRptGraph valPlanQuar(Long valPlanQuar) {
    ...
    public IctRptGraph valPlanYear(Long valPlanYear) {
    ...
    public IctRptGraph val(Long val) {
        this.val = val;
        return this;
    }
    ...
    public IctRptGraph valMon(Long valMon) {
        this.valMon = valMon;
        return this;
    }
    ...
    public IctRptGraph valQuar(Long valQuar) {
    ...
    public IctRptGraph valYear(Long valYear) {
    ...
    public IctRptGraph valLastMon(Long valLastMon) {
    ...
    public IctRptGraph valLastQuar(Long valLastQuar) {
    ...
    public IctRptGraph valLastYear(Long valLastYear) {
    ...
    public IctRptGraph valDelta(Long valDelta) {
    ...
    public IctRptGraph valDeltaMon(Long valDeltaMon) {
    ...
    public IctRptGraph valDeltaQuar(Long valDeltaQuar) {
    ...
    public IctRptGraph valDeltaYear(Long valDeltaYear) {
    ...
    public IctRptGraph percentPlan(Long percentPlan) {
    ...
    public IctRptGraph percentPlanMon(Long percentPlanMon) {
    ...
    public IctRptGraph percentPlanQuar(Long percentPlanQuar) {
    ...
    public IctRptGraph percentPlanYear(Long percentPlanYear) {
    ...
    public IctRptGraph percentGrow(Long percentGrow) {
    ...
    public IctRptGraph percentGrowMon(Long percentGrowMon) {
    ...
    public IctRptGraph percentGrowQuar(Long percentGrowQuar) {
    ...
    public IctRptGraph percentGrowYear(Long percentGrowYear) {
    ...
    public IctRptGraph colorAlarm(String colorAlarm) {
    ...
    public IctRptGraph domainCode(String domainCode) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IctRptGraph)) {
            return false;
        }
        return id != null && id.equals(((IctRptGraph) o).id);
    }
