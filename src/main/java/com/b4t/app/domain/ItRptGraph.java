 ...
 */
@Entity
@Table(name = "it_rpt_graph")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ItRptGraph implements Serializable {
    ...
    public ItRptGraph timeType(Long timeType) {
    ...
    public ItRptGraph prdId(Long prdId) {
        this.prdId = prdId;
        return this;
    }
    ...
    public ItRptGraph kpiId(Long kpiId) {
        this.kpiId = kpiId;
        return this;
    }
    ...
    public ItRptGraph kpiCode(String kpiCode) {
    ...
    public ItRptGraph kpiName(String kpiName) {
    ...
    public ItRptGraph objCode(String objCode) {
    ...
    public ItRptGraph objName(String objName) {
    ...
    public ItRptGraph parentCode(String parentCode) {
    ...
    public ItRptGraph parentName(String parentName) {
    ...
    public ItRptGraph inputLevel(Long inputLevel) {
    ...
    public ItRptGraph valPlan(Long valPlan) {
    ...
    public ItRptGraph valPlanMon(Long valPlanMon) {
    ...
    public ItRptGraph valPlanQuar(Long valPlanQuar) {
    ...
    public ItRptGraph valPlanYear(Long valPlanYear) {
    ...
    public ItRptGraph val(Long val) {
        this.val = val;
        return this;
    }
    ...
    public ItRptGraph valMon(Long valMon) {
        this.valMon = valMon;
        return this;
    }
    ...
    public ItRptGraph valQuar(Long valQuar) {
    ...
    public ItRptGraph valYear(Long valYear) {
    ...
    public ItRptGraph valLastMon(Long valLastMon) {
    ...
    public ItRptGraph valLastQuar(Long valLastQuar) {
    ...
    public ItRptGraph valLastYear(Long valLastYear) {
    ...
    public ItRptGraph valDelta(Long valDelta) {
    ...
    public ItRptGraph valDeltaMon(Long valDeltaMon) {
    ...
    public ItRptGraph valDeltaQuar(Long valDeltaQuar) {
    ...
    public ItRptGraph valDeltaYear(Long valDeltaYear) {
    ...
    public ItRptGraph percentPlan(Long percentPlan) {
    ...
    public ItRptGraph percentPlanMon(Long percentPlanMon) {
    ...
    public ItRptGraph percentPlanQuar(Long percentPlanQuar) {
    ...
    public ItRptGraph percentPlanYear(Long percentPlanYear) {
    ...
    public ItRptGraph percentGrow(Long percentGrow) {
    ...
    public ItRptGraph percentGrowMon(Long percentGrowMon) {
    ...
    public ItRptGraph percentGrowQuar(Long percentGrowQuar) {
    ...
    public ItRptGraph percentGrowYear(Long percentGrowYear) {
    ...
    public ItRptGraph colorAlarm(String colorAlarm) {
    ...
    public ItRptGraph domainCode(String domainCode) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItRptGraph)) {
            return false;
        }
        return id != null && id.equals(((ItRptGraph) o).id);
    }
