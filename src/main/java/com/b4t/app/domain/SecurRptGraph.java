 ...
 */
@Entity
@Table(name = "secur_rpt_graph")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class SecurRptGraph implements Serializable {
    ...
    public SecurRptGraph timeType(Long timeType) {
    ...
    public SecurRptGraph prdId(Long prdId) {
        this.prdId = prdId;
        return this;
    }
    ...
    public SecurRptGraph kpiId(Long kpiId) {
        this.kpiId = kpiId;
        return this;
    }
    ...
    public SecurRptGraph kpiCode(String kpiCode) {
    ...
    public SecurRptGraph kpiName(String kpiName) {
    ...
    public SecurRptGraph objCode(String objCode) {
    ...
    public SecurRptGraph objName(String objName) {
    ...
    public SecurRptGraph parentCode(String parentCode) {
    ...
    public SecurRptGraph parentName(String parentName) {
    ...
    public SecurRptGraph inputLevel(Long inputLevel) {
    ...
    public SecurRptGraph valPlan(Long valPlan) {
    ...
    public SecurRptGraph valPlanMon(Long valPlanMon) {
    ...
    public SecurRptGraph valPlanQuar(Long valPlanQuar) {
    ...
    public SecurRptGraph valPlanYear(Long valPlanYear) {
    ...
    public SecurRptGraph val(Long val) {
        this.val = val;
        return this;
    }
    ...
    public SecurRptGraph valMon(Long valMon) {
        this.valMon = valMon;
        return this;
    }
    ...
    public SecurRptGraph valQuar(Long valQuar) {
    ...
    public SecurRptGraph valYear(Long valYear) {
    ...
    public SecurRptGraph valLastMon(Long valLastMon) {
    ...
    public SecurRptGraph valLastQuar(Long valLastQuar) {
    ...
    public SecurRptGraph valLastYear(Long valLastYear) {
    ...
    public SecurRptGraph valDelta(Long valDelta) {
    ...
    public SecurRptGraph valDeltaMon(Long valDeltaMon) {
    ...
    public SecurRptGraph valDeltaQuar(Long valDeltaQuar) {
    ...
    public SecurRptGraph valDeltaYear(Long valDeltaYear) {
    ...
    public SecurRptGraph percentPlan(Long percentPlan) {
    ...
    public SecurRptGraph percentPlanMon(Long percentPlanMon) {
    ...
    public SecurRptGraph percentPlanQuar(Long percentPlanQuar) {
    ...
    public SecurRptGraph percentPlanYear(Long percentPlanYear) {
    ...
    public SecurRptGraph percentGrow(Long percentGrow) {
    ...
    public SecurRptGraph percentGrowMon(Long percentGrowMon) {
    ...
    public SecurRptGraph percentGrowQuar(Long percentGrowQuar) {
    ...
    public SecurRptGraph percentGrowYear(Long percentGrowYear) {
    ...
    public SecurRptGraph colorAlarm(String colorAlarm) {
    ...
    public SecurRptGraph domainCode(String domainCode) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecurRptGraph)) {
            return false;
        }
        return id != null && id.equals(((SecurRptGraph) o).id);
    }
