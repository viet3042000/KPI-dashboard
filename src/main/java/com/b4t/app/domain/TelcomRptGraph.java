 ...
 */
@Entity
@Table(name = "telcom_rpt_graph")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class TelcomRptGraph implements Serializable {
    ...
    public TelcomRptGraph timeType(Long timeType) {
    ...
    public TelcomRptGraph prdId(Long prdId) {
        this.prdId = prdId;
        return this;
    }
    ...
    public TelcomRptGraph kpiId(Long kpiId) {
        this.kpiId = kpiId;
        return this;
    }
    ...
    public TelcomRptGraph kpiCode(String kpiCode) {
    ...
    public TelcomRptGraph kpiName(String kpiName) {
    ...
    public TelcomRptGraph objCode(String objCode) {
    ...
    public TelcomRptGraph objName(String objName) {
    ...
    public TelcomRptGraph parentCode(String parentCode) {
    ...
    public TelcomRptGraph parentName(String parentName) {
    ...
    public TelcomRptGraph inputLevel(Long inputLevel) {
    ...
    public TelcomRptGraph valPlan(Long valPlan) {
    ...
    public TelcomRptGraph valPlanMon(Long valPlanMon) {
    ...
    public TelcomRptGraph valPlanQuar(Long valPlanQuar) {
    ...
    public TelcomRptGraph valPlanYear(Long valPlanYear) {
    ...
    public TelcomRptGraph val(Long val) {
        this.val = val;
        return this;
    }
    ...
    public TelcomRptGraph valMon(Long valMon) {
        this.valMon = valMon;
        return this;
    }
    ...
    public TelcomRptGraph valQuar(Long valQuar) {
    ...
    public TelcomRptGraph valYear(Long valYear) {
    ...
    public TelcomRptGraph valLastMon(Long valLastMon) {
    ...
    public TelcomRptGraph valLastQuar(Long valLastQuar) {
    ...
    public TelcomRptGraph valLastYear(Long valLastYear) {
    ...
    public TelcomRptGraph valDelta(Long valDelta) {
    ...
    public TelcomRptGraph valDeltaMon(Long valDeltaMon) {
    ...
    public TelcomRptGraph valDeltaQuar(Long valDeltaQuar) {
    ...
    public TelcomRptGraph valDeltaYear(Long valDeltaYear) {
    ...
    public TelcomRptGraph percentPlan(Long percentPlan) {
    ...
    public TelcomRptGraph percentPlanMon(Long percentPlanMon) {
    ...
    public TelcomRptGraph percentPlanQuar(Long percentPlanQuar) {
    ...
    public TelcomRptGraph percentPlanYear(Long percentPlanYear) {
    ...
    public TelcomRptGraph percentGrow(Long percentGrow) {
    ...
    public TelcomRptGraph percentGrowMon(Long percentGrowMon) {
    ...
    public TelcomRptGraph percentGrowQuar(Long percentGrowQuar) {
    ...
    public TelcomRptGraph percentGrowYear(Long percentGrowYear) {
    ...
    public TelcomRptGraph colorAlarm(String colorAlarm) {
    ...
    public TelcomRptGraph domainCode(String domainCode) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TelcomRptGraph)) {
            return false;
        }
        return id != null && id.equals(((TelcomRptGraph) o).id);
    }
