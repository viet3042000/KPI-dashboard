...
/**
 * REST controller for managing {@link com.b4t.app.domain.SysUserRole}.
 */
@RestController
@RequestMapping("/api")
public class SysUserRoleResource {
    ...
    public ResponseEntity<SysUserRoleDTO> createSysUserRole(@RequestBody SysUserRoleDTO sysUserRoleDTO) throws URISyntaxException {
    ...
    public ResponseEntity<SysUserRoleDTO> updateSysUserRole(@RequestBody SysUserRoleDTO sysUserRoleDTO) throws URISyntaxException {
    ...
    public ResponseEntity<List<SysUserRoleDTO>> getAllSysUserRoles(Pageable pageable) {
