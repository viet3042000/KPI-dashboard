...
/**
 * A DTO for the {@link com.b4t.app.domain.ItRptGraph} entity.
 */
public class ItRptGraphDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ItRptGraphDTO itRptGraphDTO = (ItRptGraphDTO) o;
        if (itRptGraphDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), itRptGraphDTO.getId());
    }
