...
/**
 * A DTO for the {@link com.b4t.app.domain.TelcomRptGraph} entity.
 */
public class TelcomRptGraphDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        TelcomRptGraphDTO telcomRptGraphDTO = (TelcomRptGraphDTO) o;
        if (telcomRptGraphDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), telcomRptGraphDTO.getId());
    }
