...
public class ConfigReportColumnDTO implements Serializable {
    ...
    public ConfigReportColumnDTO(String columnName, Integer columnUnique, String creator, String dataType,  Integer isPrimaryKey, Integer isRequire, Integer isShow, Integer isTimeColumn, Integer maxLength, Integer pos, Long reportId, Integer status, String title) {
