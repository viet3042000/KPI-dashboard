...
/**
 * A DTO for the {@link com.b4t.app.domain.PostalRptGraph} entity.
 */
public class PostalRptGraphDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        PostalRptGraphDTO postalRptGraphDTO = (PostalRptGraphDTO) o;
        if (postalRptGraphDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), postalRptGraphDTO.getId());
    }
