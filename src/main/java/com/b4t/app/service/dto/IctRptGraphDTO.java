...
/**
 * A DTO for the {@link com.b4t.app.domain.IctRptGraph} entity.
 */
public class IctRptGraphDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        IctRptGraphDTO ictRptGraphDTO = (IctRptGraphDTO) o;
        if (ictRptGraphDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), ictRptGraphDTO.getId());
    }
